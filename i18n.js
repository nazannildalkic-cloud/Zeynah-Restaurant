...
const translations = {
  de: {
    ...
    cta_strategy: "ZEYNAH Strategie-Session buchen",
    ...
    usecase_7_title: "🛡️ Versicherungen & Finanzen",
    usecase_7_1: "Lead-Qualifizierung für Vorsorgeprodukte",
    usecase_7_2: "KI-Analyse von Rentenlücken",
    usecase_7_3: "Automatisierte Erstberatungstermine",
    usecase_7_4: "Höhere Abschlussquoten durch Vorqualifizierung",
    ...
    form_title: "Reservierung anfragen",
    form_subtitle: "Wählen Sie Ihren Wunschtermin für ein Gespräch.",
    form_name: "Name",
    form_email: "E-Mail",
    form_date: "Datum",
    form_time: "Uhrzeit",
    form_message: "Anmerkungen",
    form_send: "Reservierung absenden",
    form_placeholder_name: "Ihr Name",
    form_placeholder_email: "ihre@email.de",
    form_placeholder_message: "Besondere Wünsche oder Fragen?",
    form_placeholder_date: "TT.MM.JJJJ",
    form_placeholder_time: "HH:MM",
    ...
    ceo_title: "Nazan Nil Dalkic | Founder & CEO",
    ...
    imperium_nav: "Imperium",
    imperium_title: "ZEYNAH Management Suite",
    imperium_desc: "Greifen Sie auf Ihr erweitertes Kontrollzentrum zu. Verwalten Sie alle Cluster und KI-Agenten von einer zentralen Oberfläche aus.",
    imperium_cta: "Imperium Dashboard öffnen",
    ...
    voice_greet_insurance: "Guten Tag! Ich bin ZEYNAH, Ihre KI-Expertin für Vorsorge. Wie kann ich Sie heute bei Ihrer Finanzplanung unterstützen?"
  },
  tr: {
    about: "Hakkımızda",
    services: "Hizmetler",
    ...
    cta_strategy: "ZEYNAH Strateji Oturumu Rezerv Edin",
    ...
    usecase_7_title: "🛡️ Sigorta & Finans",
    usecase_7_1: "Emeklilik ürünleri için müşteri adayı nitelemesi",
    usecase_7_2: "Emeklilik açığı için yapay zeka analizi",
    usecase_7_3: "Otomatik ilk danışmanlık randevuları",
    usecase_7_4: "Ön niteleme ile daha yüksek satış oranları",
    ...
    form_title: "Rezervasyon Talebi",
    form_subtitle: "Bir görüşme için istediğiniz tarihi seçin.",
    form_name: "İsim",
    form_email: "E-Posta",
    form_date: "Tarih",
    form_time: "Saat",
    form_message: "Notlar",
    form_send: "Rezervasyonu Gönder",
    form_placeholder_name: "Adınız",
    form_placeholder_email: "e-posta@adresiniz.com",
    form_placeholder_message: "Özel istekleriniz veya sorularınız mı var?",
    form_placeholder_date: "GG.AA.YYYY",
    form_placeholder_time: "SS:DD",
    modal_close: "Kapat",
    ...
    imperium_nav: "Imperium",
    imperium_title: "ZEYNAH Yönetim Paketi",
    imperium_desc: "Gelişmiş kontrol merkezinize erişin. Tüm kümeleri ve yapay zeka ajanlarını merkezi bir arayüzden yönetin.",
    imperium_cta: "Imperium Panelini Aç",
    ...
    voice_greet_insurance: "İyi günler! Ben ZEYNAH, yapay zeka sigorta uzmanınız. Finansal planlamanızda bugün size nasıl destek olabilirim?"
  },
  en: {
    about: "About Us",
    services: "Services",
    ...
    cta_strategy: "Book ZEYNAH Strategy Session",
    ...
    usecase_6_4: "Review management & follow-ups",
    usecase_7_title: "🛡️ Insurance & Finance",
    usecase_7_1: "Lead qualification for pension products",
    usecase_7_2: "AI-gap analysis for retirement",
    usecase_7_3: "Automated initial consultation appointments",
    usecase_7_4: "Higher conversion through pre-qualification",
    ...
    form_title: "Request Reservation",
    form_subtitle: "Choose your preferred date for a consultation.",
    form_name: "Name",
    form_email: "Email",
    form_date: "Date",
    form_time: "Time",
    form_message: "Notes",
    form_send: "Send Reservation",
    form_placeholder_name: "Your Name",
    form_placeholder_email: "your@email.com",
    form_placeholder_message: "Any special requests or questions?",
    ...
    imperium_nav: "Imperium",
    imperium_title: "ZEYNAH Management Suite",
    imperium_desc: "Access your advanced control center. Manage all clusters and AI agents from a central interface.",
    imperium_cta: "Open Imperium Dashboard",
    ...
    voice_greet_insurance: "Good day! I am ZEYNAH, your AI financial advisor. How can I support you with your retirement planning today?"
  }
};
